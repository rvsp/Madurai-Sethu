...
wcat=pd.read_csv("/home/venkat/Desktop/deskktop files/Excelr/Python/python regression codes and datasets/wc-at.csv")
...
# For preparing linear regression model we need to 
